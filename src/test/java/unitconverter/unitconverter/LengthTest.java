...
public class LengthTest {
    ...
    public void Length_ConversionTest_MMtoIN() {
        Length l1 = new Length();
        double value = l1.convert("mm", "in", 1320.8);
    ...
    public void Length_ConversionTest_INtoMM() {
        Length l1 = new Length();
        double value = l1.convert("in", "mm", 52);
        assertEquals(1320.8, value);
    }

    @Test
    public void Length_ConversionTest_MMtoFT() {
        Length l1 = new Length();
        double value = l1.convert("mm", "ft", 6096);
        assertEquals(20, value);
    }
    ...
    public void Length_ConversionTest_FTtoMM() {
        Length l1 = new Length();
        double value = l1.convert("ft", "mm", 20);
        assertEquals(6096, value);
    }
    ...
    public void Length_ConversionTest_CMtoMILE(){
        Length l1 = new Length();
        double value = l1.convert("cm","mile",160934.4);
        assertEquals(1, value);
    }
    ...
    public void Length_ConversionTest_MtoIN(){
        ...
        assertEquals(196.8504, value,0.0001);
    }

    @Test
    public void Length_ConversionTest_INtoM(){
        Length l1 = new Length();
        double value=l1.convert("in","m",196.8504);
        assertEquals(5, value,0.000001);
    }
    ...
    public void Length_ConversionTest_MtoMILE(){
        Length l1 = new Length();
        double value=l1.convert("m","mile",3218.688);
    ...
    public void Length_ConversionTest_KMtoIN(){
        ...
        assertEquals(78740.16, value,0.01);
    }

    @Test
    public void Length_ConversionTest_INtoKM(){
        Length l1 = new Length();
        double value=l1.convert("in","km",78740.16);
        assertEquals(2, value,0.000001);
    }
    ...
    public void Length_ConversionTest_KMtoFT(){
        ...
        assertEquals(3280.84, value,0.01);
    }
    ...
    public void Length_ConversionTest_KMtoYD(){
        ...
        assertEquals(1093.613, value,0.001);
    }

    @Test
    public void Length_ConversionTest_YDtoKM(){
        Length l1 = new Length();
        double value=l1.convert("yd","km",1093.613);
    ...
    public void Length_ConversionTest_KMtoMILE(){
        ...
        assertEquals(3.106856, value,0.000001);
    }
    ...
    public void Length_ConversionTest_FTtoIN(){
        ...
        assertEquals(72, value,0.0000000000001);
    }
    ...
    public void Length_ConversionTest_MILEtoIN(){
        ...
        assertEquals(126720, value,0.0000000001);
    }
